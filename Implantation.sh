...
sudo cp Chrooting.sh /mnt/home/ && CHROOT_KEYBOARD="${KEYBOARD}" && chmod +x /mnt/home/Chrooting.sh && sudo arch-chroot /mnt /bin/bash sh -ec '/home/Chrooting.sh; rm /home/Chrooting.sh; exit'
